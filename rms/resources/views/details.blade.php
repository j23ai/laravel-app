...
<div class="container">
   <div class="row">
        <div class="col-sm-12">
        <img class="card-img-top" src="{{ asset('image/'.$result->image) }}" height="300px" alt="Card image">
        </div>
   </div>
  <div class="row">
      <div class="col-sm-12">
         <div class="card">
           <div class="card card-body">
             {{$result->name}}
             <p class="card-text">{{$result->place}}</p>
             <p>Discount: {{$result->discount}}</p>
             <p>Contact: {{$result->contact}}</p>
             <p>Menu Item: {!! $result->menu_item !!}</p>
             <p>Manager Name: {{$result->manager_name}}</p>
           </div>
         </div>
      </div>
  </div>
